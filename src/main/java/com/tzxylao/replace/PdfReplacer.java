...
public class PdfReplacer {
	 ...
	 */
	private ReplaceRegion process() throws DocumentException, IOException{
		try{
			parseReplaceText();
			canvas.saveState();
	        Set<Entry<String, ReplaceRegion>> entrys = replaceRegionMap.entrySet();
			ReplaceRegion value = null;
	...
	private void parseReplaceText() {
		...
		try {
			Map<String, ReplaceRegion> parseResult = parse.parse(this);
	 ...
	 * @throws IOException
	 */
	public ReplaceRegion toPdf(String fileName) throws DocumentException, IOException{
		FileOutputStream fileOutputStream = null;
		try{
            ReplaceRegion process = process();
